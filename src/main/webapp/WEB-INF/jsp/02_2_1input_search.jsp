												...
												<li class="nav-item nav-search d-lg-block">
													<div class="input-group">
														...
														<input type="text" class="form-control"
															id="navbar-search-input" placeholder="음식 이름 검색"
										...
										<ul
											...
											<li>
												<div class="form-check form-check-flat">
													<label class="form-check-label"> <input
														class="checkbox" type="checkbox" checked> 김치찌게
													</label>
												</div> <i class="remove ti-close"></i>
											</li>
											<li>
											...
											<li>
												<div class="form-check form-check-flat">
													<label class="form-check-label"> <input
														class="checkbox" type="checkbox" checked> 스팸 김치찌게
													</label>
												</div> <i class="remove ti-close"></i>
											</li>
											<li>
												<div class="form-check form-check-flat">
													<label class="form-check-label"> <input
														class="checkbox" type="checkbox" checked> 삼겹살 김치찌게
													</label>
												</div> <i class="remove ti-close"></i>
											</li>
											
										</ul>
									<button type="submit" class="btn btn-primary mr-2">추가</button>
