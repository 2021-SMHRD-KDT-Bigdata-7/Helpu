    ...
    return {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [170.3, 153.2, 90.6, 40.6, 160.4, 190],
          borderWidth: 1
        }, {
          label: '적정 섭취량',
...
var audienceChartInit = function audienceChartInit() {
  var data = {
    ...
    dataset: {
      users: [[60.3, 70.6, 79.5, 69.1, 78.2, 67.3, 76.4], [237, 229, 707, 575, 420, 536, 258]],
      sessions: [[1622, 1694, 1435, 1537, 1791, 2292, 1806], [584, 661, 214, 286, 526, 707, 627]],
      rate: [[189, 149, 212, 197, 233, 154, 120], [276, 739, 525, 394, 643, 653, 719]],
      duration: [[25, 69, 79, 54, 49, 42, 50], [499, 670, 550, 222, 696, 695, 469]]
    }
  };
  ...
  if (tab) {
    initChart(document.querySelector('.echart-audience'), getDefaultOptions(data.dataset.users[0]));
    ...
    triggerTabList.forEach(function (triggerEl) {
      triggerEl.addEventListener('shown.bs.tab', function () {
        ...
        initChart($echartAudience, getDefaultOptions(data.dataset[key][0]));
      });
    });
  }
};
/* -------------------------------------------------------------------------- */
/*, data.dataset.users[1], data.dataset[key][1]*/
/*                            Bandwidth Saved                                 */
