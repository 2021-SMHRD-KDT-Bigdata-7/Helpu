(function($) {
  ...
  $(function() {
    ...
    if ($("#south-america-chart_mr").length) {
      var areaData = {
        labels: ["현재","목표"],
        datasets: [{
            data: [76, 65],
      ...
      var southAmericaChartCanvas_mr = $("#south-america-chart_mr").get(0).getContext("2d");
      var southAmericaChart_mr = new Chart(southAmericaChartCanvas_mr, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
        plugins: southAmericaChartPlugins1
      });
      //document.getElementById('south-america-legend').innerHTML = southAmericaChart_mr.generateLegend();
    }
    
    if ($("#south-america-chart_lu").length) {
      var areaData = {
        labels: ["현재","목표"],
        datasets: [{
            data: [78, 65],
      ...
      var southAmericaChartCanvas_lu = $("#south-america-chart_lu").get(0).getContext("2d");
      var southAmericaChart_lu = new Chart(southAmericaChartCanvas_lu, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
        plugins: southAmericaChartPlugins
      });
      //document.getElementById('south-america-legend').innerHTML = southAmericaChart_lu.generateLegend();
    }
    
    
    if ($("#south-america-chart_din").length) {
      var areaData = {
        labels: ["현재","목표"],
        datasets: [{
            data: [77, 65],
      ...
      var southAmericaChartCanvas_din = $("#south-america-chart_din").get(0).getContext("2d");
      var southAmericaChart_din = new Chart(southAmericaChartCanvas_din, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
        plugins: southAmericaChartPlugins
      });
      //document.getElementById('south-america-legend').innerHTML = southAmericaChart_din.generateLegend();
    }
    if ($("#south-america-chart_sna").length) {
      var areaData = {
        labels: ["현재","목표"],
        datasets: [{
            data: [76, 65],
      ...
      var southAmericaChartCanvas_sna = $("#south-america-chart_sna").get(0).getContext("2d");
      var southAmericaChart_sna = new Chart(southAmericaChartCanvas_sna, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
        plugins: southAmericaChartPlugins
      });
      //document.getElementById('south-america-legend').innerHTML = southAmericaChart_sna.generateLegend();
    }
